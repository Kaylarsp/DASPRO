...
public class StrukMain15 {
    Scanner sc = new Scanner(System.in);
    
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        Struk15 stk = new Struk15(20);
        StrukMain15 main = new StrukMain15();
    ...
    public void pushPakaian(Struk15 stk) {
        char pilih;
        do {
            ...
            Struk15 d = new Struk15(noTra, tanggal, jumlah, total);
